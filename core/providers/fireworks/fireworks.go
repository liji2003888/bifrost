...
// TextCompletion is not supported by the Fireworks AI provider.
...
// TextCompletionStream is not supported by the Fireworks AI provider.
...
// Embedding is not supported by the Fireworks AI provider.
